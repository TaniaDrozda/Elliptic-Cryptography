            ...
            {               
                ...
                for (BigInteger w = Start; w < End; w += Step)
                {
                    ...
                    for (int i = 0; i < quantity; i++)
                    {
                        ...
                        time = 0;
                        Point_Multiplication_Affine_Coord_4(points[i, 0], points[i, 1], 1, a, k1, (int)w, p, out x2, out y2, out z2, out time, type);
                        time_average[1, j] += time;
                        stopWatch.Reset();
                        ...
                        time = 0;
                        Point_Multiplication_Affine_Coord_10(points[i, 0], points[i, 1], 1, a, k1, (int)w, p, out x2, out y2, out z2, out time, type);
                        time_average[5, j] += time;
                        stopWatch.Reset();
                        ...
                        time = 0;
                        Point_Multiplication_Affine_Coord_12(points[i, 0], points[i, 1], 1, a, k1, (int)w, p, out x2, out y2, out z2, out time, type);
                        time_average[8, j] += time;
                        stopWatch.Reset();
            ...
            foreach (var k1 in mass_k)
            {
                ...
                for (BigInteger a_max = AStart; a_max < AEnd; a_max += AStep)
                {
                    ...
                    for (BigInteger b_max = BStart; b_max < BEnd; b_max += BStep)
                    {
                        ...
                        {
                            time = 0;
                            PointMultiplication.Point_Multiplication_Affine_Coord_19(points[i, 0], points[i, 1], 1, a, k1, p,
                            out x2, out y2, out z2, out time, type, a_max, b_max);
                            ...
                            time = 0;
                            PointMultiplication.Point_Multiplication_Affine_Coord_20(points[i, 0], points[i, 1], 1, a, k1, p,
                            out x2, out y2, out z2, out time, type, a_max, b_max);
